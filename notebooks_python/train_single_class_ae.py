...
reset_tf_graph()  # 重置 TensorFlow 图，以确保新模型可以在干净的图中加载和训练
ae = PointNetAutoEncoder(conf.experiment_name, conf)  # 创建 PointNetAutoEncoder 的实例
